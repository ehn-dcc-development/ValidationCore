#
#  Be sure to run `pod spec lint ValidationCore.podspec' to ensure this is a
...
- Verify COSE signature
  ...
  spec.author             = { "Hannes Van den Berghe" => "hannes.vandenberghe@icapps.com" }
  # Or just: spec.author    = "Hannes Van den Berghe"
  # spec.authors            = { "Hannes Van den Berghe" => "hannes.vandenberghe@icapps.com" }
  # spec.social_media_url   = "https://twitter.com/Hannes Van den Berghe"

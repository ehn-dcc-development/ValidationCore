...
public struct ValidationCore {
    private static let DEFAULT_TRUSTLIST_URL = "https://dgc.a-sit.at/ehn/cert/"
    ...
    public init(trustlistService: TrustlistService? = nil, dateService: DateService? = nil, trustlistUrl: String? = nil, trustAnchor : String? = nil){
        let dateService = dateService ?? DefaultDateService()
        self.dateService = dateService
        self.trustlistService = trustlistService ?? DefaultTrustlistService(dateService: dateService, trustlistUrl: trustlistUrl ?? ValidationCore.DEFAULT_TRUSTLIST_URL, trustAnchor: trustAnchor ?? ValidationCore.DEFAULT_TRUSTANCHOR)
